<template>
    <nav class="navbar navbar-expand-lg bg-primary-subtle shadow p-3">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><nuxt-link to="/profil/identitasSekolah" class="dropdown-item">Identitas Sekolah</nuxt-link></li>
                            ...
                            <li><nuxt-link to="/profil/kepalaSekolah" class="dropdown-item">Kepala Sekolah</nuxt-link></li>
                            <li><nuxt-link to="/profil/konsentrasiKeahlian" class="dropdown-item">Konsentrasi Keahlian</nuxt-link></li>
                            <li><nuxt-link to="/profil/guruDanStaf" class="dropdown-item">Guru dan Staf</nuxt-link></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <nuxt-link to="/galeri/galeri" class="nav-link" aria-current="page" href="#">Galeri</nuxt-link>
                    </li>
                    <li class="nav item">
                        <nuxt-link to="/artikel/artikel" class="nav-link" aria-current="page">Artikel</nuxt-link>
                    </li>
                </ul>
            </div>
        </div>
